...
public class Solution {
    ...
    {
        Solution solution = new Solution(1, "Солюшн", 4d, new Date(1220227200L), null);
        HashSet<Solution> hashSet = new HashSet<>();
        hashSet.add(solution);
        System.out.println(hashSet.contains(new Solution(1, "Солюшн", 4d, new Date(1220227200L), null)));
    }
}
