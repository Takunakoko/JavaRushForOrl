...
public class Solution
{
    ...
    {
        BigInteger tempInt = new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());

        return new Number(expectedNumerationSystem, tempInt.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
    }
}
