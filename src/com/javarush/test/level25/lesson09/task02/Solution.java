...
public class Solution extends TimerTask {
    ...
    public Solution(TimerTask original) {
        ...
        this.handler = new Thread.UncaughtExceptionHandler(){
            ...
            {
                String nameThread = t.getName();                        //Имя самой нити
                String nameInStar = nameThread.replaceAll(".", "*");    //Сообщение из run
                System.out.println(e.getMessage().replaceFirst(nameThread, nameInStar));
            }
        };    //init handler here
    }
