...
public class Solution {
    ...
    int var3;
    int var4;
    private final Object lock0 = new Object();          //Создаем два мифических объекта
    private final Object lock1 = new Object();          //По которым можно независимо лочить/синхронизировать
