...
public class Solution {
    ...
    public static class OutputToConsole implements Externalizable {
        ...
        public OutputToConsole(){
            //Необходим коснтруктор без параметров для Externalizable,
            // так как задан конструктор с параметрами
            //дефолтный конструктор НЕ СОЗДАЕТСЯ автоматически.
        }
    ...
    public static void main(String[] args){
        ...
        outputToConsole.outputToConsole(3);
    }
}
