...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            {
                System.out.println(ivanov.assets.get(i).getName() +" "+ "\t" + somePerson.assets.get(i).getName());
                System.out.println(ivanov.assets.get(i).getPrice() + " " + "\t" + somePerson.assets.get(i).getPrice());
            }
            inputStream.close();
